...
# 自建接官方api接口的，此项目增加代理配置：[huangzt/ChatGPTAPIFree](https://github.com/huangzt/ChatGPTAPIFree)
## 反向代理接口fork自大老的：[acheong08/ChatGPT-to-API](https://github.com/acheong08/ChatGPT-to-API)
